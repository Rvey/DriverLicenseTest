    ...
    <>
      <div className="py-0.5 flex justify-between draggable">
        ...
        <div className="inline-flex -mt-1">
          <button onClick={window.Main.Minimize} className="undraggable md:px-4 lg:px-3 pt-1 hover:bg-gray-300 w-10">
            &#8211;
          </button>
          <button onClick={handleToggle} className="undraggable px-6  px-5 pt-1 hover:bg-gray-300">
            {isMaximize ? '\u2752' : '⃞'}
          </button>
